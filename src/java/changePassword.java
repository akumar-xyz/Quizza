...
public class changePassword extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String newPWD = request.getParameter("Opassword");
            String oldPwd = request.getParameter("Npassword");
            java.sql.Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/quizza", "root", "root");
//            out.println("test2");
            String query = "update subjects set subject_passkey=? where subject_code=? and subject_passkey=?";
